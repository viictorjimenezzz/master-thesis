...
\begin{figure}[H]
    ...
    \label{fig:logits_confidence_app}
\end{figure}
...
Some exploratory experiments in real scenarios were performed, comparing
...
\begin{table}[H]
    ...
    \midrule
    SD & 99.3 & 99.4 & {\textbf{99.5}} & 54.8 & {\textbf{71.5}} & 64.0 & {\textbf{81.0}} & 54.3 & 79.9 & 74.5 & 48.6 & {\textbf{76.1}} & 53.4 & 34.9 & {\textbf{57.9}} & {\textbf{35.8}} & 32.7 & 35.2 \\
    ID & 99.4 & \textbf{99.5} & {\textbf{99.5}} & {\textbf{72.8}} & 69.9 & 70.1 & 85.5 & 85.8 & {\textbf{88.5}} & {\textbf{79.5}} & 76.0 & 79.1 & 55.6 & {\textbf{66.6}} & 60.7 & 38.3 & {\textbf{38.9}} & 34.6 \\
    1F-MD & {\textbf{99.5}} & 99.4 & 99.4 & 48.2 & 45.1 & {\textbf{51.0}} & 74.6 & 77.6 & {\textbf{79.8}} & 65.7 & 68.9 & {\textbf{75.3}} & 59.7 & 58.2 & {\textbf{63.3}} & 42.8 & {\textbf{44.8}} & 38.3 \\
    5F-MD & 99.5 & 99.5 & 99.5 & 49.6 & 49.6 & 49.6 & 90.2 & 90.2 & 90.2 & 81.0 & 81.0 & 81.0 & 71.4 & 71.4 & 71.4 & 44.6 & 44.6 & 44.6 \\
    OOD & 99.3 & \textbf{99.4} & {\textbf{99.4}} & 60.9 & \textbf{69.3} & {\textbf{69.3}} & {\textbf{92.6}} & 87.3 & 87.3 & {\textbf{83.9}} & 82.1 & 82.1 & {\textbf{64.9}} & 59.6 & 59.6 & 32.3 & \textbf{39.0} & {\textbf{39.0}} \\
    \midrule
    \addlinespace
    \addlinespace
    ...
    \midrule
    SD & 99.4 & 99.2 & {\textbf{99.6}} & {\textbf{61.4}} & 52.2 & 45.1 & 85.7 & 69.5 & {\textbf{91.6}} & 78.3 & 58.6 & {\textbf{78.5}} & 55.7 & {\textbf{58.9}} & 56.5 & 43.2 & 27.2 & {\textbf{45.5}} \\
    ...
    \textbf{{\color{tab:blue} \textbf{ERM}}} & Acc. & AFR$_\text{P}$ & PA & Acc. & AFR$_\text{P}$ & PA & Acc. & AFR$_\text{P}$ & PA & Acc. & AFR$_\text{P}$ & PA & Acc. & AFR$_\text{P}$ & PA & Acc. & AFR$_\text{P}$ & PA \\
    \midrule
    SD & 99.3 & 99.2 & {\textbf{99.4}} & 99.4 & 99.3 & {\textbf{99.5}} & 86.6 & 82.1 & {\textbf{87.4}} & 68.5 & 59.7 & {\textbf{74.5}} & 50.8 & 47.6 & {\textbf{56.4}} & 47.4 & 46.4 & {\textbf{57.6}} \\
    ID & 99.3 & \textbf{99.4} & {\textbf{99.4}} & 99.4 & 99.5 & {\textbf{99.6}} & {\textbf{86.6}} & 86.5 & 85.3 & 68.5 & {\textbf{75.3}} & 74.2 & 50.8 & {\textbf{57.1}} & 54.8 & 47.4 & {\textbf{57.1}} & 55.6 \\
    1F-MD & 99.3 & {\textbf{99.4}} & 99.3 & {\textbf{99.5}} & 99.4 & 99.4 & 84.9 & 83.6 & {\textbf{89.0}} & 66.3 & 66.3 & {\textbf{68.0}} & 52.0 & 47.0 & {\textbf{53.6}} & 46.3 & 41.4 & {\textbf{53.6}} \\
    5F-MD & 99.1 & 99.1 & 99.1 & 99.1 & 99.1 & 99.1 & 90.1 & 90.1 & 90.1 & 58.6 & 58.6 & 58.6 & 73.3 & 73.3 & 73.3 & 57.4 & 57.4 & 57.4 \\
    OOD & 99.3 & 99.3 & 99.3 & 99.4 & 99.4 & 99.4 & {\textbf{89.0}} & 89.0 & 84.2 & {\textbf{68.0}} & \textbf{68.0} & 60.4 & {\textbf{53.6}} & \textbf{53.6} & 46.8 & {\textbf{53.6}} & \textbf{53.6} & 45.0 \\
    \midrule
    \addlinespace
    \addlinespace
    \textbf{{\color{tab:orange} \textbf{IRM}}} & Acc. & AFR$_\text{P}$ & PA & Acc. & AFR$_\text{P}$ & PA & Acc. & AFR$_\text{P}$ & PA & Acc. & AFR$_\text{P}$ & PA & Acc. & AFR$_\text{P}$ & PA & Acc. & AFR$_\text{P}$ & PA \\
    \midrule
    SD & {\textbf{99.4}} & 98.8 & 99.3 & {\textbf{99.4}} & 98.7 & 99.2 & {\textbf{85.0}} & 65.3 & 83.2 & 55.0 & {\textbf{58.4}} & 51.2 & 59.0 & {\textbf{68.9}} & 52.1 & 51.4 & {\textbf{58.8}} & 45.2 \\
    ID & {\textbf{99.4}} & 99.3 & 99.2 & 99.4 & 99.3 & {\textbf{99.5}} & {\textbf{86.4}} & 81.1 & 83.0 & 50.4 & 46.2 & {\textbf{62.4}} & 48.2 & 54.2 & 70.4 & 39.8 & 45.5 & {\textbf{59.6}} \\
...
\subsection{In-distribution DiagVib-6}
...
\begin{table}[H]
    ...
    \textbf{{\color{tab:blue} \textbf{ERM}}} & Acc. & AFR$_\text{P}$ & PA & Acc. & AFR$_\text{P}$ & PA & Acc. & AFR$_\text{P}$ & PA & Acc. & AFR$_\text{P}$ & PA & Acc. & AFR$_\text{P}$ & PA \\
    \midrule
    ZGO & 53.2 & 53.2 & 53.2 & 54.6 & 54.6 & 54.6 & 55.7 & 55.7 & 55.7 & 66.7 & 66.7 & 66.7 & 66.6 & 66.6 & 66.6 \\
    1-CGO & 62.9 & \textbf{72.4} & {\textbf{72.4}} & 64.7 & \textbf{74.8} & {\textbf{74.8}} & 60.8 & \textbf{61.1} & {\textbf{61.1}} & 62.9 & \textbf{65.1} & {\textbf{65.1}} & 64.2 & \textbf{64.7} & {\textbf{64.7}} \\
    2-CGO & 69.1 & \textbf{78.6} & {\textbf{78.6}} & 71.2 & \textbf{78.9} & {\textbf{78.9}} & 71.9 & \textbf{72.2} & {\textbf{72.2}} & {\textbf{76.2}} & 73.8 & 73.8 & {\textbf{77.0}} & 74.2 & 74.2 \\
    3-CGO & 73.1 & \textbf{89.8} & {\textbf{89.8}} & 85.6 & \textbf{89.3} & {\textbf{89.3}} & 70.1 & \textbf{79.8} & {\textbf{79.8}} & 71.4 & \textbf{77.7} & {\textbf{77.7}} & 72.1 & \textbf{78.8} & {\textbf{78.8}} \\
    ZSO & 99.6 & 99.6 & 99.6 & {\textbf{92.8}} & 92.7 & 92.7 & 89.9 & \textbf{90.0} & {\textbf{90.0}} & 85.9 & {\textbf{86.0}} & \textbf{86.0} & 85.9 & {\textbf{86.0}} & \textbf{86.0}\\
    \midrule
    \addlinespace
    \addlinespace
    \textbf{{\color{tab:orange} \textbf{IRM}}} & Acc. & AFR$_\text{P}$ & PA & Acc. & AFR$_\text{P}$ & PA & Acc. & AFR$_\text{P}$ & PA & Acc. & AFR$_\text{P}$ & PA & Acc. & AFR$_\text{P}$ & PA \\
    \midrule
    ZGO & 50.1 & \textbf{56.0} & {\textbf{56.0}} & 50.5 & \textbf{55.4} & {\textbf{55.4}} & 52.8 & \textbf{62.3} & {\textbf{62.3}} & 64.4 & \textbf{65.5} & {\textbf{65.5}} & 64.9 & \textbf{66.0} & {\textbf{66.0}} \\
...
\begin{table}[H]
    ...
    \textbf{{\color{tab:blue} \textbf{ERM}}} & Acc. & AFR$_\text{P}$ & PA & Acc. & AFR$_\text{P}$ & PA & Acc. & AFR$_\text{P}$ & PA & Acc. & AFR$_\text{P}$ & PA & Acc. & AFR$_\text{P}$ & PA \\
    \midrule
    ZGO & 50.2 & 50.2 & {\textbf{50.2}} & 50.0 & \textbf{50.0} & {\textbf{50.0}} & 52.4 & 52.4 & 52.4 & 52.0 & 52.0 & 52.0 & 50.6 & 50.6 & 50.6 \\
    1-CGO & 44.1 & 48.2 & {\textbf{48.2}} & 41.4 & \textbf{42.0} & {\textbf{42.0}} & 43.6 & \textbf{45.0} & {\textbf{45.0}} & 45.0 & \textbf{46.0} & {\textbf{46.0}} & 44.8 & \textbf{46.0} & {\textbf{46.0}} \\
    2-CGO & 64.4 & {\textbf{71.8}} & 71.4 & 53.4 & 52.5 & {\textbf{55.1}} & 55.1 & 55.9 & {\textbf{57.8}} & 57.7 & {\textbf{60.5}} & 59.0 & 56.7 & {\textbf{59.0}} & 58.0 \\
    3-CGO & 73.2 & \textbf{91.1} & {\textbf{91.1}} & 55.3 & \textbf{63.6} & {\textbf{63.6}} & 52.8 & \textbf{61.3} & {\textbf{61.3}} & 51.8 & \textbf{58.8} & {\textbf{58.8}} & 51.8 & \textbf{59.1} & {\textbf{59.1}} \\
    ZSO & \textbf{99.1} & 98.4 & {\textbf{99.1}} & {\textbf{92.1}} & 91.6 & 91.9 & 88.6 & 86.2 & {\textbf{88.8}} & 87.0 & 84.3 & {\textbf{87.1}} & 85.7 & 84.6 & {\textbf{85.9}} \\
    \midrule
    \addlinespace
    \addlinespace
    \textbf{{\color{tab:orange} \textbf{IRM}}} & Acc. & AFR$_\text{P}$ & PA & Acc. & AFR$_\text{P}$ & PA & Acc. & AFR$_\text{P}$ & PA & Acc. & AFR$_\text{P}$ & PA & Acc. & AFR$_\text{P}$ & PA \\
    ...
    1-CGO & 48.2 & \textbf{49.0} & {\textbf{49.0}} & 43.6 & \textbf{44.2} & {\textbf{44.2}} & {\textbf{43.2}} & 42.8 & 42.8 & {\textbf{44.0}} & 42.4 & 42.2 & {\textbf{44.1}} & 42.1 & 42.0 \\
    2-CGO & 65.0 & {\textbf{72.2}} & 72.0 & 53.1 & 57.6 & {\textbf{58.6}} & 52.8 & 54.0 & {\textbf{54.1}} & {\textbf{59.2}} & 58.6 & 55.6 & {\textbf{60.1}} & 58.7 & 55.4 \\
...
\begin{dataset}[Robustness assessment]
...
\begin{dataset}[Test \texttt{hue}] Some experiments in Section \ref{chapter:msel_controlled}
...
\begin{dataset}[Test \texttt{position}] Some experiments in Section \ref{chapter:msel_controlled}
...
\begin{dataset}[Training and validation \texttt{position}]
    Some experiments in Section \ref{chapter:msel_controlled}
...
\begin{dataset}[ID setting under ZGO]\label{def:zgo_experiments}
...
\begin{dataset}[ID setting under 1-CGO]\label{def:1_cgo_experiments}
    Let the predicted factor $F^P$ be \texttt{shape} (i.e. the image digits), and let the 
...
\begin{dataset}[ID setting under 2-CGO]\label{def:2_cgo_experiments}
    Let the predicted factor $F^P$ be \texttt{shape} (i.e. the image digits), and let the 
    learned factor $F^L$ be \texttt{hue} and \texttt{position}, each for a different dataset. The 
...
\begin{dataset}[ID setting under 3-CGO]\label{def:3_cgo_experiments}
    Let the predicted factor $F^P$ be \texttt{shape} (i.e. the image digits), and let the 
    learned factor $F^L$ be \texttt{hue} and \texttt{position}, each for a different dataset. The 
...
\begin{dataset}[ID setting under ZSO]\label{def:zso_experiments}
    Let the predicted factor $F^P$ be \texttt{shape} (i.e. the image digits), and let the 
    learned factor $F^L$ be \texttt{hue} and \texttt{position}, each for a different dataset. The 
