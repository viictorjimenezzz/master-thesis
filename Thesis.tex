...
\studentA{V\'ictor Jim\'enez Rodr\'iguez}
\ethidA{97-906-739}
\semesterA{5}
...
\supervision{Dr. Jo\~ao Borges de S\'a Carvalho, Dr. Alessandro Torcinovich \\ Prof. Dr. Joachim M. Buhmann}
\date{September 2024}
...
\cleardoublepage
\input{chapters/results_robustness_assessment}
\cleardoublepage
\input{chapters/results_model_selection}
\cleardoublepage

\input{chapters/conclusion}
\cleardoublepage

% \input{chapters/docs1}
% \cleardoublepage
